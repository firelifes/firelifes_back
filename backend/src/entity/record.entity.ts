...
export class Record {
  ...
  @Column({ name: 'type_id', type: 'int', nullable: true, comment: '分类ID，调整类记录可为空' })
  typeId?: number;
  ...
  @Column({ length: 20, comment: '类型：income-收入，expense-支出，transfer-转账，repayment-还债，adjustment_increase-调增，adjustment_decrease-调减' })
